    ...
    <div class="w-screen h-screen flex justify-center items-center">
        <div class="relative w-2/5 h-4/5 group">
            ...
            <div class="w-full h-full relative bg-black rounded-3xl leading-none flex flex-col justify-center items-center">
                ...
                <p class="text-white font-mono text-3xl mt-14 font-semibold">{{ $nama }}</p>
                <p class="text-white font-mono text-3xl mt-1 font-semibold">{{ $nama_kelas ?? 'Kelas tidak ditemukan' }}</p>
                <p class="text-white font-mono text-3xl mt-1 font-semibold">{{ $npm }}</p>
            </div>
        </div>
    </div>
</body>
